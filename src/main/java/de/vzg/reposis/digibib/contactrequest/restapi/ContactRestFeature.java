...
/**
 * Jersey configuration for contact request end point.
 */
public class ContactRestFeature extends MCRJerseyDefaultFeature {
    ...
    protected List<String> getPackages() {
        return MCRConfiguration2.getString(ContactRequestConstants.CONF_PREFIX + "API.Resource.Packages")
            .map(MCRConfiguration2::splitValue).orElse(Stream.empty()).collect(Collectors.toList());
    }
