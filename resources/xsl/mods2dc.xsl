...
-->
    ...
    <dc:identifier>
        ...
        <xsl:choose>
          ...
          <xsl:when test="@type='arxiv'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/arxiv/',.)" />
          </xsl:when>
          <xsl:when test="@type='hdl'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/hdl/',.)" />
          </xsl:when>
          <xsl:when test="@type='isbn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/isbn/',.)" />
          </xsl:when>
          <xsl:when test="@type='issn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/issn/',.)" />
          </xsl:when>
          <xsl:when test="@type='pissn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/pissn/',.)" />
          </xsl:when>
          <xsl:when test="@type='eissn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/eissn/',.)" />
          </xsl:when>
          <xsl:when test="@type='uri'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/uri/',.)" />
          </xsl:when>
          <xsl:when test="@type='wos'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/wos/',.)" />
          </xsl:when>
          <xsl:when test="@type='purl'">
            <xsl:value-of select="concat('info:eu-repo/semantics/altIdentifier/purl/',.)" />
          </xsl:when>
  ...
  <xsl:template match="mods:relatedItem/mods:identifier">
      <dc:relation>
        <xsl:choose>
          <xsl:when test="@type='urn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/urn/',$MCR.URN.Resolver.MasterURL, .)" />
          </xsl:when>
          <xsl:when test="@type='doi'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/doi/',.)" />
          </xsl:when>
          <xsl:when test="@type='ark'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/ark/',.)" />
          </xsl:when>
          <xsl:when test="@type='arxiv'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/arxiv/',.)" />
          </xsl:when>
          <xsl:when test="@type='hdl'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/hdl/',.)" />
          </xsl:when>
          <xsl:when test="@type='isbn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/isbn/',.)" />
          </xsl:when>
          <xsl:when test="@type='issn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/issn/',.)" />
          </xsl:when>
          <xsl:when test="@type='pissn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/pissn/',.)" />
          </xsl:when>
          <xsl:when test="@type='eissn'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/eissn/',.)" />
          </xsl:when>
          <xsl:when test="@type='uri'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/uri/',.)" />
          </xsl:when>
          <xsl:when test="@type='wos'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/wos/',.)" />
          </xsl:when>
          <xsl:when test="@type='purl'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/purl/',.)" />
          </xsl:when>
          <xsl:when test="@type='pmid'">
            <xsl:value-of select="concat('info:eu-repo/semantics/reference/pmid/',.)" />
          </xsl:when>
        </xsl:choose>
      </dc:relation>
  </xsl:template>
